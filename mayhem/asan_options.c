/*
 * ericw-tools/mayhem/asan_options.c — ASan runtime option overrides.
 *
 ...
 * definition wins at link time and is linked into both the fuzzer and the standalone
 * reproducer via build.sh.
 */
